...
import { LayoutDashboard, Mail, Settings, LogOut, ShieldCheck, Menu, X, Plus, History, Zap, Megaphone } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/scouting', label: 'Scouting', icon: Megaphone },
